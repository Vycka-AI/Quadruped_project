...
model = PPO.load("../models/Backup/PPO_Minimal_New/rl_model_minimal_14638720_steps.zip", env=env)
...
with mujoco.viewer.launch_passive(env.model, env.data) as viewer:
    ...
    while viewer.is_running():
        ...
        env.print_base_velocities()  # <-- Add this line
        print("Contact even reward {}".format(env._reward_contact_evenness()))
        #print(f"Obs: {obs}")
